...
Data_Fn = function(Version, obsmodel_p=NULL,  b_i, s_i, t_i, p_i, a_x, n_cointegrate=NULL, n_factors=1,
  ...
  a_k = c(a_x, rep(0,MeshList$mesh$n-nrow(MeshList$loc_x)))
  ...
  if( Version%in%c("spatial_vam_v14","spatial_vam_v13","spatial_vam_v12","spatial_vam_v11","spatial_vam_v10","spatial_vam_v9","spatial_vam_v8","spatial_vam_v7","spatial_vam_v6","spatial_vam_v5","spatial_vam_v4","spatial_vam_v3","spatial_vam_v2","spatial_vam_v1")){
    ...
    M0 = Spatial_List$MeshList$spde$param.inla[["M0"]]
    M1 = Spatial_List$MeshList$spde$param.inla[["M1"]]
    M2 = Spatial_List$MeshList$spde$param.inla[["M2"]]
    ...
    if("spde" %in% names(Return)) Return[['spde']] = list("n_s"=MeshList$spde$n.spde, "n_tri"=nrow(MeshList$mesh$graph$tv), "Tri_Area"=MeshList$Tri_Area, "E0"=MeshList$E0, "E1"=MeshList$E1, "E2"=MeshList$E2, "TV"=MeshList$TV-1, "G0"=MeshList$spde$param.inla$M0, "G0_inv"=INLA::inla.as.dgTMatrix(solve(MeshList$spde$param.inla$M0)) )
